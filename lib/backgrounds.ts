...
export const backgrounds = {
  ...
  main: {
    ...
    fullscreen: "min-h-screen bg-gradient-to-br from-[#fad182] via-[#f5c55a] to-[#fad182]",
  ...
  card: {
    ...
    flashcard: "bg-gradient-to-br from-[#fad182] via-[#fad182] to-[#f5c55a] shadow-xl border-2 border-[#705a39]",
...
export function bg(
  ...
  throw new Error(`Invalid background key: ${backgroundKey}${variant ? `.${variant}` : ''}`);
}
