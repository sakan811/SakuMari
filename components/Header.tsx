          ...
          <nav className="hidden lg:flex items-center space-x-4 xl:space-x-6">
            {session ? (
              ...
              <div className="relative" ref={signInRef}>
                ...
                {showSignInOptions && (
                  <div className="absolute top-full mt-2 right-0 bg-white rounded-lg shadow-xl border-2 border-[#d1622b] min-w-[280px] z-50">
                    <div className="p-4">
                      <button
                        onClick={() => {
                          signIn("google");
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 mb-3 bg-[#4285f4] hover:bg-[#3367d6] text-white rounded-lg transition-colors duration-200 font-medium"
                        type="button"
                      >
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 bg-[#403933] hover:bg-[#705a39] text-[#fad182] rounded-lg transition-colors duration-200 font-medium border-2 border-[#d1622b]"
                        type="button"
                      >
